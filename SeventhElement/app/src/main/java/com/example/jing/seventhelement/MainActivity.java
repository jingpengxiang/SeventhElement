...
import com.example.jing.seventhelement.view.fragment.CategoryFragment;
import com.example.jing.seventhelement.view.fragment.DiscoveryFragment;
import com.example.jing.seventhelement.view.fragment.HomeFragment;
import com.example.jing.seventhelement.view.fragment.PersonFragment;
import com.example.jing.seventhelement.view.widget.TabStripView;
...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //分类
        navigateTabBar.addTab(CategoryFragment.class, new TabStripView.TabParam(R.drawable.ic_tab_bar_person, R.drawable.ic_tab_bar_person_selected, R.string.abc_tab_text_category));
        //发现
